            ...
            <div className="flex-1 min-h-screen max-w-[70%] sm:max-w-[50%] md:max-w-[65%] lg:max-w-[70%] py-8 flex items-center justify-center">
                <div className="w-full h-[100%] bg-white rounded-2xl shadow-xl overflow-hidden">
                    <div className="w-full bg-white rounded-3xl shadow-2xl overflow-hidden">
                        ...
                        <div className="flex flex-col lg:flex-row overflow-y-auto my-2 overflow-x-hidden" style={{
                                    ...
                                    <ul className="flex">
                                        {tabs.map((tab, index) => (
                                            <li
                                                ...
                                                className={`px-8 py-5 cursor-pointer transition duration-300 flex items-center flex-1 justify-center ${activeTab === index
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <div className="flex justify-between pt-8 mt-8" style={{ borderTop: '2px solid var(--color-lightermoonstone)' }}>
                                            <button
                                                ...
                                                className={`px-8 py-4 rounded-2xl font-bold text-lg transition duration-300 flex items-center transform hover:scale-105 ${activeTab === 0
                                                    ? 'invisible'
